...
# When the custom kernel configuration path is empty, use the exact running
# host kernel configuration. This deliberately uses /boot/config-$(uname -r)
# rather than scanning /boot/config-* so multiple installed host kernels do not
